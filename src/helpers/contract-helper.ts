...
export function getMemeJettonMinterCode(testnet: boolean) {
  const minter = fs.readFileSync(path.resolve(__dirname, testnet ? './contracts/sources/testnet/meme_jetton_minter.cell' : './contracts/sources/meme_jetton_minter.cell'))
